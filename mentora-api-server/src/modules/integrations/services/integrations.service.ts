...
const providerCatalog: ProviderCatalogItem[] = [
  ...
  },
  {
    ...
    envKeys: [
      ...
      'NOTIFICATION_SMS_DELIVERY_CALLBACK_URL',
      'NOTIFICATION_SMS_DELIVERY_CALLBACK_SECRET',
    ...
    requiredConfigPaths: [
      ...
      'notification.sms.deliveryCallbackUrl',
      'notification.sms.deliveryCallbackSecret',
      'notification.sms.msg91.authKey',
      'notification.sms.msg91.templateId',
    ],
  },
  {
    key: 'notification_callbacks',
    module: 'notifications',
    external: true,
    docs: 'Email, SMS, and push provider delivery callback endpoints',
    envKeys: [
      'NOTIFICATION_EMAIL_DELIVERY_CALLBACK_URL',
      'NOTIFICATION_EMAIL_DELIVERY_CALLBACK_SECRET',
      'NOTIFICATION_SMS_DELIVERY_CALLBACK_URL',
      'NOTIFICATION_SMS_DELIVERY_CALLBACK_SECRET',
      'NOTIFICATION_PUSH_DELIVERY_CALLBACK_URL',
      'NOTIFICATION_PUSH_DELIVERY_CALLBACK_SECRET',
    ],
    requiredConfigPaths: [
      'notification.email.deliveryCallbackUrl',
      'notification.email.deliveryCallbackSecret',
      'notification.sms.deliveryCallbackUrl',
      'notification.sms.deliveryCallbackSecret',
      'notification.push.deliveryCallbackUrl',
      'notification.push.deliveryCallbackSecret',
    ],
  },
  {
    key: 'email_delivery',
  ...
  },
  {
    ...
    requiredConfigPaths: [
      ...
      'integrations.dialer.webhookSecret',
      'integrations.dialer.callbackUrl',
      'integrations.dialer.recordingCallbackUrl',
    ],
  },
  {
    key: 'calendar_sync',
    ...
    envKeys: [
      ...
      'CALENDAR_REMINDER_WEBHOOK_URL',
      'CALENDAR_CALLBACK_SECRET',
    ],
    requiredConfigPaths: [
      ...
      'integrations.calendar.reminderWebhookUrl',
      'integrations.calendar.callbackSecret',
    ],
  },
  {
  ...
  {
    key: 'import_export_storage',
    module: 'imports-exports',
    external: true,
    docs: 'CSV import/export storage, transfer, and callback configuration',
    envKeys: [
      'IMPORT_EXPORT_PROVIDER_ENABLED',
      'IMPORT_EXPORT_PROVIDER',
      'IMPORT_EXPORT_PROVIDER_API_KEY',
      'IMPORT_EXPORT_PROVIDER_BASE_URL',
      'IMPORT_EXPORT_CALLBACK_SECRET',
    ],
    requiredConfigPaths: [
      'integrations.importExport.enabled',
      'integrations.importExport.provider',
      'integrations.importExport.apiKey',
      'integrations.importExport.baseUrl',
      'integrations.importExport.callbackSecret',
    ],
  },
  {
    key: 'education_ops',
    module: 'education',
    external: true,
    docs: 'Application form provider, LMS/ERP handoff, live classroom, and tax provider placeholders',
    envKeys: [
      'EDUCATION_FORM_PROVIDER_ENABLED',
      'EDUCATION_FORM_PROVIDER_API_KEY',
      'EDUCATION_LMS_PROVIDER_ENABLED',
      'EDUCATION_LMS_PROVIDER_API_KEY',
      'EDUCATION_CLASSROOM_PROVIDER_ENABLED',
      'EDUCATION_CLASSROOM_PROVIDER_API_KEY',
      'EDUCATION_TAX_PROVIDER_ENABLED',
      'EDUCATION_TAX_PROVIDER_API_KEY',
      'EDUCATION_OPS_CALLBACK_SECRET',
    ],
    requiredConfigPaths: [
      'integrations.educationOps.formProviderEnabled',
      'integrations.educationOps.formProviderApiKey',
      'integrations.educationOps.lmsProviderEnabled',
      'integrations.educationOps.lmsProviderApiKey',
      'integrations.educationOps.classroomProviderEnabled',
      'integrations.educationOps.classroomProviderApiKey',
      'integrations.educationOps.taxProviderEnabled',
      'integrations.educationOps.taxProviderApiKey',
      'integrations.educationOps.callbackSecret',
    ],
  },
  {
