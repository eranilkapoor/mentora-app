...
const providerCatalog = [
  ...
  { key: 'whatsapp_business', module: 'whatsapp', external: true },
  { key: 'sms_gateway', module: 'sms', external: true },
  { key: 'email_delivery', module: 'emails', external: true },
  { key: 'dialer_recording', module: 'call-center', external: true },
  { key: 'calendar_sync', module: 'calendar', external: true },
  { key: 'webinar_provider', module: 'events', external: true },
  { key: 'ocr_verification', module: 'documents', external: true },
  { key: 'geo_telemetry', module: 'field-force', external: true },
