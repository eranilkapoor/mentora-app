...
export type CountryGuideDocument = HydratedDocument<CountryGuide>;

@Schema({ collection: COLLECTION_NAMES.COUNTRY_GUIDE, timestamps: true })
...
export const CountryGuideSchema = SchemaFactory.createForClass(CountryGuide);
CountryGuideSchema.index({ organizationId: 1, status: 1, dueAt: 1 });
