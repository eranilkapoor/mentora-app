...
export class CountriesController {
  ...
  async bulkUpdateStatus(
    ...
    return successResponse(
      ...
      'COUNTRIES_BULK_STATUS_UPDATED',
      'Country guides updated',
    );
  }
  @Delete(':recordId')
  @Permissions(Permission.MODULE_RECORD_MANAGE)
