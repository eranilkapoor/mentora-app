        ...
        <div style="max-width:640px;margin:0 auto;padding:32px 18px;">
          <div style="background:#ffffff;border-radius:24px;overflow:hidden;border:1px solid #f7d5df;box-shadow:0 16px 40px rgba(124,45,70,0.10);">
            <div style="padding:28px 30px;background:linear-gradient(135deg,#ff7a9e,#b83280);color:#ffffff;">
              ...
              <h1 style="margin:10px 0 0;font-size:28px;line-height:1.25;">Your Mentora profile is ready</h1>
            </div>
            <div style="padding:30px;">
              <p style="margin:0 0 16px;font-size:16px;line-height:1.65;">Namaste ${safeName},</p>
              <p style="margin:0 0 18px;font-size:15px;line-height:1.65;">Your onboarding is complete and your AI tutoring profile is now live. We will use your profile and learning preferences to improve discovery and recommendations.</p>
              ...
              <p style="margin:0;font-size:14px;line-height:1.65;color:#6b7280;">Best wishes,<br/>Team Mentora</p>
            </div>
          </div>
          <p style="margin:18px 8px 0;text-align:center;font-size:12px;line-height:1.5;color:#9ca3af;">This message confirms that onboarding for your Mentora account was completed.</p>
        </div>
      </div>
    `;
  }
