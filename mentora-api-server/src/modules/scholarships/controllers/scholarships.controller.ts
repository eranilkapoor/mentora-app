...
export class ScholarshipsController {
  ...
  async bulkUpdateStatus(
    ...
    return successResponse(
      ...
      'SCHOLARSHIPS_BULK_STATUS_UPDATED',
      'Scholarships bulk status updated',
    );
  }
  @Delete(':recordId')
  @Permissions(Permission.MODULE_RECORD_MANAGE)
