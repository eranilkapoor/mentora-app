...
const createFixture = () => {
  const models = {
    ...
    classrooms: createModel(),
    classroomMessages: createModel(),
    classroomFiles: createModel(),
    tutorSessionNotes: createModel(),
  ...
  const service = new LearningService(
    ...
    models.classrooms as never,
    models.classroomMessages as never,
    models.classroomFiles as never,
    models.tutorSessionNotes as never,
