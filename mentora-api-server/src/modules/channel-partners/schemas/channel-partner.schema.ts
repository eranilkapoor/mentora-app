...
@Schema({ collection: COLLECTION_NAMES.CHANNEL_PARTNER, timestamps: true })
...
export const ChannelPartnerSchema =
  SchemaFactory.createForClass(ChannelPartner);
ChannelPartnerSchema.index({ organizationId: 1, status: 1, dueAt: 1 });
