...
export class ChannelPartnersController {
  ...
  @Get() @Permissions(Permission.MODULE_RECORD_VIEW) async list(
    ...
    return successResponse(
      ...
      'CHANNEL_PARTNERS_FETCHED',
      'Channel partners fetched',
    );
  }
  ...
  async exportRecords(@Query('organizationId') organizationId: string) {
    return successResponse(
      ...
      'CHANNEL_PARTNERS_EXPORTED',
      'Channel partners exported',
    );
  }
  @Get(':recordId') @Permissions(Permission.MODULE_RECORD_VIEW) async getById(
    ...
    return successResponse(
      ...
      'CHANNEL_PARTNER_FETCHED',
      'Channel partner fetched',
    );
  }
  ...
  async bulkUpdateStatus(
    ...
    return successResponse(
      ...
      'CHANNEL_PARTNERS_BULK_STATUS_UPDATED',
      'Channel partners updated',
    );
  }
  @Delete(':recordId')
  @Permissions(Permission.MODULE_RECORD_MANAGE)
  async archive(
    ...
    return successResponse(
      ...
      'CHANNEL_PARTNER_ARCHIVED',
      'Channel partner archived',
    );
  }
  ...
  async restore(
    ...
    return successResponse(
      ...
      'CHANNEL_PARTNER_RESTORED',
      'Channel partner restored',
    );
  }
  ...
  async complete(
    ...
    return successResponse(
      ...
      'CHANNEL_PARTNER_APPROVED',
      'Channel partner approved',
    );
  }
}
