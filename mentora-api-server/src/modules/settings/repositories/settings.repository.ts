...
export class SettingsRepository {
  ...
  async getOrCreateUserSettings(userId: string) {
    ...
    const created = await this.updateNotification(userId, {
      ...
      preferences: {
        sessionScheduled: { inApp: true, push: true, email: true, sms: false },
        sessionReminder: { inApp: true, push: true, email: true, sms: false },
        progressUpdate: { inApp: true, push: true, email: false, sms: false },
        parentAlert: { inApp: true, push: true, email: true, sms: false },
