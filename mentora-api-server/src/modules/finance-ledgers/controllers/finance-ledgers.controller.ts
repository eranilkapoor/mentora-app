...
export class FinanceLedgersController {
  ...
  async bulkUpdateStatus(
    ...
    return successResponse(
      ...
      'LEDGER_ENTRIES_BULK_STATUS_UPDATED',
      'ledger entries bulk status updated',
    );
  }
