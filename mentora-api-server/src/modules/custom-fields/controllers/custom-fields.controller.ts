...
const MODULE_KEY = 'custom-fields';
...
export class CustomFieldsController {
  ...
  async bulkUpdateStatus(
    ...
    return successResponse(
      ...
      'CUSTOM_FIELDS_BULK_STATUS_UPDATED',
      'Custom fields bulk status updated',
    );
  }
