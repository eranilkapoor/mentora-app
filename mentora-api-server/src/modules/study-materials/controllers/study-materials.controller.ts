...
export class StudyMaterialsController {
  ...
  @Get() @Permissions(Permission.MODULE_RECORD_VIEW) async list(
    ...
    return successResponse(
      ...
      'STUDY_MATERIALS_FETCHED',
      'Study materials fetched',
    );
  }
  ...
  @Get(':recordId') @Permissions(Permission.MODULE_RECORD_VIEW) async getById(
    ...
    return successResponse(
      ...
      'STUDY_MATERIAL_FETCHED',
      'Study material fetched',
    );
  }
  ...
  async bulkUpdateStatus(
    ...
    return successResponse(
      ...
      'STUDY_MATERIALS_BULK_STATUS_UPDATED',
  ...
  async restore(
    ...
    return successResponse(
      ...
      'STUDY_MATERIAL_RESTORED',
      'Study material restored',
    );
  }
