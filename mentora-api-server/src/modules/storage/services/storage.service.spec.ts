...
const createConfig = (
  ...
  const values: Record<string, string | undefined> = {
    ...
    'storage.awsS3Bucket': 'mentora-bucket',
    'storage.awsS3BaseUrl': 'https://mentora-bucket.s3.amazonaws.com///',
    'storage.awsRegion': 'ap-south-1',
    'api.baseUrl': 'https://api.mentora.test/api/v1',
    ...overrides,
  };
...
describe('StorageService', () => {
  ...
  it('uploads to S3 and returns the API proxy URL', async () => {
    ...
    expect(result.url).toBe(
      'https://api.mentora.test/uploads/videos/file-uuid.mp4',
    );
    expect(logger.log).toHaveBeenCalledWith(
