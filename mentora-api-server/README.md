...
NestJS API server for the Mentora AI tutoring platform. The server owns authentication, onboarding, profiles, preferences, discovery, matching, chat, notifications, payments, subscriptions, settings, safety, storage, analytics, and seeding.
