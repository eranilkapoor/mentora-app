...
type Props = {
  navigation: NativeStackNavigationProp<SettingsStackParamList, 'EditPreference'>;
};
...
//   const [updateAboutPartner] = useUpdateAboutPartnerMutation();
  ...
  const setSettings = useCallback(
    (
      ...
      value: MatchSettings[keyof MatchSettings]
    ) => {
      setPreference((p) => ({
        ...p,
  ...
  const setWeight = useCallback(
    (key: keyof MatchWeights, value: number) => {
      setPreference((p) => ({
        ...p,
  ...
  if (pageLoading) {
    return (
      <Loader
        fullScreen
        size="large"
        loadingText={t('preference.loading')}
      />
    );
  }
        ...
        >
          ...
          >
            ...
            <PreferenceToggleRow
              ...
              onChange={(v) =>
                setSettings('profileVerificationRequired', v)
              }
            />
          ...
          >
            ...
            <View style={styles.weightsTotalRow}>
              ...
              <Text
                style={[
                  styles.weightsTotalValue,
                  { color: weightsTotalColor },
                ]}
              >
                {weightsTotal}/100
              </Text>
