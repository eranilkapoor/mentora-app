export enum FeatureKey {
  ...
  PRIORITY_CHAT = 'priority_chat', // message goes on top
  READ_RECEIPTS = 'read_receipts',
  MESSAGE_TRANSLATION = 'message_translation',

  // ==========================================
  // 👁️ PROFILE VISIBILITY / DISCOVERY
  // ==========================================
  ...
  CONTROL_PROFILE_VISIBILITY = 'control_profile_visibility',
  ...
  DEDICATED_RELATIONSHIP_MANAGER = 'relationship_manager',
