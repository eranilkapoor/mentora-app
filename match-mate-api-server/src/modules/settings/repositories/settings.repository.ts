...
export class SettingsRepository {
  ...
  async getOrCreateUserSettings(userId: string) {
    ...
    const created = await this.updateNotification(userId, {
      ...
      preferences: {
        interestReceived: { inApp: true, push: true, email: false, sms: false },
        interestAccepted: { inApp: true, push: true, email: false, sms: false },
        profileView: { inApp: true, push: true, email: false, sms: false },
        matchFound: { inApp: true, push: true, email: false, sms: false },
