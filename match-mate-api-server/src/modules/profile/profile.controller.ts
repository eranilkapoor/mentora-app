...
import { CreateProfileDto, EducationDto, FamilyDto, PersonalDto, PhysicalDto, PreferencesDto } from './dto/create-profile.dto';
...
export class ProfileController {
  ...
  async create(@CurrentUser('userId') userId: string, @Body() dto: CreateProfileDto) {
    try {
      ...
      return new ApiResponse(false, error.message || 'Failed to create profile', null);
    }
  }
  ...
  async update(@CurrentUser('userId') userId: string, @Body() dto: UpdateProfileDto) {
    try {
      ...
      return new ApiResponse(false, error.message || 'Failed to update profile', null);
    }
  }

  @Patch('personal')
  async updatePersonal(@CurrentUser('userId') userId: string, @Body() dto: PersonalDto) {
    try {
      ...
      return new ApiResponse(false, error.message || 'Failed to update personal info', null);
    }
  }

  @Patch('physical')
  async updatePhysical(@CurrentUser('userId') userId: string, @Body() dto: PhysicalDto) {
    try {
      ...
      return new ApiResponse(false, error.message || 'Failed to update physical info', null);
    }
  }

  @Patch('education')
  async updateEducation(@CurrentUser('userId') userId: string, @Body() dto: EducationDto) {
    try {
      ...
      return new ApiResponse(false, error.message || 'Failed to update education info', null);
    }
  }

  @Patch('family')
  async updateFamily(@CurrentUser('userId') userId: string, @Body() dto: FamilyDto) {
    try {
      ...
      return new ApiResponse(false, error.message || 'Failed to update family info', null);
    }
  }

  @Patch('preferences')
  async updatePreferences(@CurrentUser('userId') userId: string, @Body() dto: PreferencesDto) {
    try {
      ...
      return new ApiResponse(false, error.message || 'Failed to update preferences', null);
    }
  }
  ...
  async getMyProfile(@CurrentUser('userId') userId: string) {
    try {
      ...
      return new ApiResponse(false, error.message || 'Failed to retrieve profile', null);
    }
  }
}
