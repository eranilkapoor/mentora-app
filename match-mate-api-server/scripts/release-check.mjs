...
const checks = [
  { name: "env validation", command: "npm", args: ["run", "migration:validate"] },
  { name: "provider configuration smoke", command: "npm", args: ["run", "smoke:providers:strict"] },
  { name: "lint", command: "npm", args: ["run", "lint:check"] },
  { name: "typecheck", command: "npm", args: ["run", "typecheck"] },
  { name: "tests", command: "npm", args: ["run", "test", "--", "--runInBand"] },
  { name: "build", command: "npm", args: ["run", "build"] },
  { name: "openapi contract drift", command: "npm", args: ["--prefix", "..", "run", "contracts:check"] },
  { name: "mobile i18n checks", command: "npm", args: ["--prefix", "..", "run", "i18n:check"] },
];
