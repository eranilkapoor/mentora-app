...
| Organization safety | Organization-owned data cannot leak across organizations, branches, or unauthorized users. |
...
| Integration | API and frontend connected, auth and organization context verified, empty/error states checked. |
...
| High | Major workflow broken, organization context broken, provider callback failure, billing mismatch. | Fix before release. |
