...
| R2 | Organization/branch/role access is not fully verified in staging. | 2 | 3 | 6 | QA/Tech Lead | Run organization matrix UAT and access review. | Open |
...
| A3 | Providers can be activated by environment variables and organization-level configs. | Provider smoke tests. | DevOps | Open |
