...
| Documents                            | With selected organization: create/list/filter/edit/request/load/verify/OCR metadata/archive/restore/bulk status/export using document-specific fields.                                                               |
...
- Education admin screens must use module-specific forms and payload mapping. Applications, Admissions, Documents, Scholarships, Interviews, Students, Academic Sessions, Courses, Specializations, Enrollment, Fees, and Learning Ops are wired to dedicated admin routes instead of generic module-record screens.
