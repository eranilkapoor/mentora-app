...
| PARTIAL | Upgrade/downgrade/plan lifecycle     | Initial activation, billing screens, Google receipt verification/acknowledgement, restore, and RTDN reconciliation exist. Live renewal/cancellation/refund evidence and Apple Server Notifications remain.                    |
...
| PARTIAL | Auto-renewal/subscription lifecycle  | Receipt verification, acknowledgement, active/grace status, expiry, replay protection, and Google RTDN handling are implemented. Apple Server Notifications V2 and live renewal/cancellation/refund evidence remain required. |
