...
type PostOnboardingTarget = 'EditProfile' | 'Schedule';
...
export default function OnboardingSuccessScreen(): React.ReactElement {
  ...
  const onboardingGuide = [
    ...
    },
    {
      ...
      title: t('onboarding.success.guide.schedule.title'),
      description: t('onboarding.success.guide.schedule.description'),
    },
    {
  ...
  const enterSchedule = useCallback((): void => {
    enterTarget('Schedule');
  }, [enterTarget]);
  ...
  const enterApp = useCallback(
    ...
    [enterEditProfile, enterSchedule]
  );
      ...
      >
        <View style={styles.successCard}>
          ...
          <TouchableOpacity
            ...
            onPress={() => enterApp('Schedule')}
            accessibilityRole="button"
            accessibilityLabel={t('onboarding.success.cta_schedule')}
            activeOpacity={0.86}
          >
            <Text style={styles.successSecondaryButtonText}>
              {t('onboarding.success.cta_schedule')}
            </Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
