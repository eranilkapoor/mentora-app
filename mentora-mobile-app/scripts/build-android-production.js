...
const uploadSigningEnv =
  existsSync(keystorePath) && existsSync(credentialsPath)
    ? {
        MENTORA_UPLOAD_STORE_FILE: keystorePath,
        MENTORA_UPLOAD_STORE_PASSWORD: readCredential('Store password'),
        MENTORA_UPLOAD_KEY_ALIAS: 'match-mate-production',
        MENTORA_UPLOAD_KEY_PASSWORD: readCredential('Key password'),
      }
    : {};
